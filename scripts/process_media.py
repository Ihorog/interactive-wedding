...
Usage:
    python scripts/process_media.py --input /path/to/raw_media --output /path/to/OUT
...
7. Write output to OUT/<section_slug>/<uuid>.<ext>
8. Generate OUT/wedding_manifest.json.
...
def write_manifest(manifest: List[Dict], output_dir: Path) -> Path:
    """Serialize manifest to OUT/wedding_manifest.json."""
    manifest_path = output_dir / "wedding_manifest.json"
